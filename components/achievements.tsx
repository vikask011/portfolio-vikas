...
export default function Achievements() {
  const achievements = [
    ...
    {
      /* Replaced "Full Stack Developer" with Avishkar Hackathon achievement */
      icon: Zap,
  ...
  return (
    <section id="achievements" className="py-10 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Achievements & Awards</h2>
          <p className="text-gray-600 text-lg">Recognition and accomplishments in competitions and professional work</p>
        </div>
          ...
          {achievements.map((achievement) => {
            ...
            return (
              <div
                ...
                className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-100 hover:shadow-lg transition-all"
              >
                ...
                <p className="text-blue-600 text-xs font-medium mb-2">{achievement.description}</p>
                <p className="text-gray-600 text-xs leading-relaxed">{achievement.detail}</p>
              </div>
            )
          })}
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-8 border border-gray-200">
          <h3 className="text-2xl font-bold text-gray-900 mb-6">{highlights[0].title}</h3>
